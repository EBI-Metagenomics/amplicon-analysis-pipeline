...
The amplicon analysis pipeline v6 re-implements all of the existing features from v5.0:
...
The amplicon analysis pipeline v6 also contains multiple significant changes:
